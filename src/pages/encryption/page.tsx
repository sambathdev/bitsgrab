    ...
    <div className="flex flex-col items-center p-2">
      <header className="text-center mb-4">
        ...
        <p className="text-slate-400 mt-2">
          Secure Browser-Based Encryption & Decryption
        </p>
      </header>
        ...
        <div className="p-2 rounded-xl shadow-2xl border border-border">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              {cipherText && (
                <button
                  onClick={() => copyCipherText(cipherText)}
                  className="absolute top-2 right-2 p-2 bg-slate-100 hover:bg-slate-600 rounded-md transition"
                >
                  {copiedCipherText ? (
        ...
        <div className="p-2 rounded-xl shadow-2xl border border-border">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              {decryptedText && (
                <button
                  onClick={() => copyDecryptedText(decryptedText)}
                  className="absolute top-2 right-2 p-2 bg-slate-100 hover:bg-slate-600 rounded-md transition"
                >
                  {copiedDecryptedText ? (
                    <CheckIcon className="h-5 w-5 text-green-400" />
